...
from keras.layers import GlobalAveragePooling2D,LeakyReLU,UpSampling2D,Activation
...
def build_generator(input_shape):
    ...
    model.add(SNConv2D(512,(3,3),input_shape=input_shape,padding="same"))
    model.add(LeakyReLU(0.2))

    model.add(UpSampling2D((2,2)))
    model.add(SNConv2D(256,(3,3),padding="same"))
    model.add(LeakyReLU(0.2))

    model.add(UpSampling2D((2,2)))
    model.add(SNConv2D(128,(3,3),padding="same"))
    model.add(LeakyReLU(0.2))

    model.add(UpSampling2D((2,2)))
    model.add(SNConv2D(64,(3,3),padding="same"))
    model.add(LeakyReLU(0.2))

    model.add(SNConv2D(3,(3,3),padding="same",activation="tanh"))
    return model
...
def build_discriminator(input_shape):
    ...
    model.add(SNConv2D(64,(3,3),input_shape=input_shape,padding="same"))
    model.add(LeakyReLU(0.2))
